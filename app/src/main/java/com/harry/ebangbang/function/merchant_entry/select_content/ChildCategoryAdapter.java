 ...
 */
public class ChildCategoryAdapter extends BaseQuickAdapter<SelectContentCategoryChildEntity.DataBean, BaseViewHolder> {

    private int lastPosition = -1;

    public ChildCategoryAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(final BaseViewHolder helper, final SelectContentCategoryChildEntity.DataBean item) {
