 ...
 */
public class OrderStatusAdapter extends BaseQuickAdapter<OrderManageEntity.DataBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, OrderManageEntity.DataBean item) {
        ...
        for (int i = 0; i < item.goods.size(); i++) {
            ...
            View view = View.inflate(mContext, R.layout.item_order_status_child, null);
