 ...
 */
public class ChildAddressAdapter extends BaseQuickAdapter<SelectContentAddressChildEntity.DataBean, BaseViewHolder> {

    private int lastPosition = -1;

    public ChildAddressAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(final BaseViewHolder helper, final SelectContentAddressChildEntity.DataBean item) {
